...
class _SignupPageState extends State<SignupPage> {
  ...
  //BookFunctions bookFunctions = BookFunctions();
  ...
  Widget showHandleInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        autofocus: false,
        decoration: new InputDecoration(
            hintText: 'Handle - This must be unique',
            icon: new Icon(
              Icons.mail,
              color: Colors.grey,
            )),
  ...
  Widget showUsernameInput() {
    return Padding(
      ...
      child: new TextFormField(
        ...
        autofocus: false,
        decoration: new InputDecoration(
            hintText: 'Username - This can be changed at anytime',
            icon: new Icon(
              Icons.mail,
              color: Colors.grey,
            )),
